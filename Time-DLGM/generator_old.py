...
class Generator(nn.Module):
    ...
    # Two layered NN acting as a matrix
    def get_g(self):
    ...
    def get_state_dimensions(self):
        return self.internal_state[0][0].size(), len(self.internal_state)


    def set_state(self, internal_state):
        self.internal_state = internal_state

    def forward(self, xi=None):
        ...
        for t, g in zip(self.T, self.G):
            ...
            mid_val = g(xi[count + 1]).to(self.device))
            z = res + mid_val
